...
namespace MarketService.AsyncDataServices
{
    public class MessageBusClient : IMessageBusClient
    {
        ...
        public void SendInstrumentBalanceExport(InstrumentBalanceExportPublishedDto instrumentsBalanceExportPublishedDto)
        {
            var message = JsonSerializer.Serialize(instrumentsBalanceExportPublishedDto);
